        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form:form method="post" action="/cage/type/edit" modelAttribute="cageType">
                        <form:hidden path="id"/>
                        <div class="form-group">
                            <label for="input-name">Cage Type Name</label>
                            <form:input id="input-name" path="cageName" type="text" required="required" class="form-control" placeholder="Cage Type Name"/>
                        </div>
