        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form:form method="post" action="/staff/duty/add" modelAttribute="staffDuty">
                        <div class="form-group">
                            <label for="description">Description</label>
                            <form:input id="input-description" path="description" type="text" required="required" class="form-control" placeholder="description"/>
                        </div>
                        <div class="form-spec">
