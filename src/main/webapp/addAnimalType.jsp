        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form:form method="post" action="/animal/type/add" modelAttribute="animalType">
                        <div class="form-group">
                            <label for="typeName">Animal Type Name</label>
                            <form:input id="input-typeName" required="required" path="typeName" type="text" class="form-control" placeholder="Animal Type Name"/>
                        </div>
                        <div class="form-spec">
